...
def main():
	...
	#spawnModel(gazebo,ball,[8.5 0 1])
        ...
        print("")
        print("----------------------------------------------------------")
        print("Welcome to the Tossingbot Throw")
        print("----------------------------------------------------------")
        ...
        #tutorial.go_to_pose_goal(0.5, 0, 0, 1)
        
        
        
        #tutorial.attach_object_to_robot(object_name, link_name)
        
        
        
        

        tutorial.go_to_joint_state(0, -100, 0, -175, 0, 90, 45)
        ...
        tutorial.go_to_joint_state(0, 44, 0, -4, 0, 135, 45)
